      ...
      <div className="card mb-6 !p-3">
        ...
        <div className="grid grid-cols-7 gap-1">
          {[0, 1, 2, 3, 4, 5, 6].map((i) => {
            ...
            return (
              <div key={d} className={`rounded-lg p-1.5 text-center ${d === now ? "ring-2 ring-ink" : "ring-1 ring-sand-200"} ${d < now && !st.some(isDone) ? "bg-red-50" : ""}`}>
        ...
        <p className="mt-2 text-[11px] text-stone-500">{tr("grün = gepostet · hellgrün = freigegeben · beige = geplant · rot = Tag vorbei ohne Story", "groen = gepost · lichtgroen = goedgekeurd · beige = gepland · rood = dag voorbij zonder story")}</p>
      </div>
